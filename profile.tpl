...
<div class="ui center aligned" id="profile-header"
...
<div class="ui stackable grid" id="profile">
    <div class="ui centered row profile-feed">
        ...
        <div
            ...
            {/if}
            {if $CAN_VIEW}
            <div class="ui top attached tabular menu no-border">
                <a class="item profile-btns active" data-tab="feed">{$FEED}</a>
                <a class="item profile-btns" data-tab="about">{$ABOUT}</a>
                {foreach from=$TABS key=key item=tab}
                <a class="item profile-btns" data-tab="{$key}">{$tab.title}</a>
                {/foreach}
            </div>
            <div class="ui bottom attached tab segment profile-feed-active active" data-tab="feed" id="profile-feed">
                {if isset($LOGGED_IN)}
            ...
            <div class="ui bottom attached tab segment" data-tab="about" id="profile-about">
                ...
                <div class="profileFields">
                    <div class="item">
                        <i class="middle aligned user add icon profileIcon"></i>
                    ...
                    <div class="item">
                        <i class="middle aligned clock icon profileIcon"></i>
                        <div class="middle aligned content" data-toggle="popup">
                    ...
                    <div class="item">
                        <i class="middle aligned eye icon profileIcon"></i>
                ...
                <div class="ui relaxed list" style="padding-top: 30px;">
                    {foreach from=$ABOUT_FIELDS key=key item=field}
                    {if is_numeric($key)}
                    <div class="item">
                        <i
                            class="middle aligned {if $field.type eq 'date'}calendar alternate{else}dot circle{/if} icon profileIcon"></i>
