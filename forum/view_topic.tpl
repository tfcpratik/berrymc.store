...
<div class="ui segments" id="topic-post" post-id="{$reply.id}">
    <div class="ui attached padded segment silkyTView">
        <div class="ui stackable grid">
            <div class="ui row">
                <div class="ui five wide tablet three wide computer column" id="post-sidebar">
                    ...
                    <div class="ui list">
                        <div class="item">
                            <div class="content silkyField">
                                <div class="header" style="color:#fff!important;font-weight:600;">{$reply.user_topics_count|regex_replace:'/[0-9]+/':''|capitalize}
                                </div>
                                <div class="res right floated description" style="color:#fff!important;font-weight:600;">
                                    {$reply.user_topics_count|regex_replace:'/[^0-9]+/':''}</div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="content silkyField">
                                <div class="header" style="color:#fff!important;font-weight:600;">{$reply.user_posts_count|regex_replace:'/[0-9]+/':''|capitalize}
                                </div>
                                <div class="res right floated description" style="color:#fff!important;font-weight:600;">
