...
<div class="ui stackable padded grid forumIndex" id="forum-index">
...
<div class="ui stackable padded grid forumIndex" id="forum-index">
    <div class="ui centered row">
        ...
        <div
            ...
            <div class="ui padded block-container" id="forum-node">
                <h3 class="ui header mainTitle"><a href="{$forum.link}">{$forum.title}</a></h3>
                <div class="ui middle aligned stackable grid">
                    {foreach from=$forum.subforums item=subforum}
                    {if $subforum->redirect_forum neq 1}
                    <div class="centered row forumNode">
                        <div class="one wide column mobile hidden">{if empty($subforum->icon)}
                            <i class="ui large comment icon forumIcon middle aligned"></i>
                            {else}{$subforum->icon}{/if}
                        </div>
                        <div class="nine wide column forumNodee">
                            <a class="header forumTitle" href="{$subforum->link}" data-toggle="popup">{$subforum->forum_title}</a>
                            ...
                            <div class="description">
                                ...
                                <li class="gridz">
                                        {foreach from=$subforum->subforums item=sub_subforum}
                                        <a class="card-body-gridz item" href="{$sub_subforum->link}">
